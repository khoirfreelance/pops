    ...
    <div class="d-flex flex-column flex-md-row">
      ...
      >
        ...
        <div class="configuration-banner text-white p-5 d-flex flex-column flex-md-row justify-content-between align-items-center">
          <div>
            <h2 class="fw-bold mb-2">Data Catin</h2>
        ...
        <div class="container-fluid mt-4 d-flex flex-wrap gap-2 justify-content-end">
          ...
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalImport" @click.prevent="openImport('Import Kunjungan')">
            <i class="bi bi-filetype-csv"></i> Import Pendampingan TPK
          </button>
        </div>
