              ...
              <form @submit.prevent="handleSubmit" class="row g-4">
                ...
                <div class="col-md-6">
                  ...
                  <div v-if="previewLogo" class="mt-2 text-center">
                    <img :src="previewLogo" alt="Logo Preview" class="img-fluid rounded" style="max-height: 100px;" />
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" v-model="form.logoWidth" class="form-control" placeholder="e.g. 120" />
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div v-if="previewBackground" class="mt-2 text-center">
                    <img :src="previewBackground" alt="Background Preview" class="img-fluid rounded" style="max-height: 150px;" />
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="color" v-model="form.colorTheme" class="form-control form-control-color" />
                </div>

                <!-- Footer Column -->
                <div class="col-md-6">
                  <label class="form-label fw-bold">Footer Column</label>
                  <input type="number" min="1" max="6" v-model="form.footerColumn" class="form-control" />
                </div>
