          ...
          <div class="card modern-card mt-4">
            <div class="card-body">
              <div class="table-responsive">
                Content of Intervention Schedule
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="modal-body">
          <form class="row g-4">
            <!-- No TPK -->
            <div class="col-md-12">
              <label class="form-label small fw-semibold text-secondary">Tanggal Intervensi</label>
              <input type="number" min="0" class="form-control shadow-sm" v-model="form.intervensi" />
            </div>
          </form>
        </div>
